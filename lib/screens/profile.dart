...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Map<String, Object> userNotes = await Provider.of<NotesProvider>(context).fetchUserNotes();
    return Scaffold(
      ...
      body: FutureBuilder(
        future: Provider.of<NotesProvider>(context, listen: false).fetchUserNotes(),
        builder: (context, snapshot) {
          ...
          if(snapshot.hasData) {
            Map<String, Object> userNotes = snapshot.data!;
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  ProfileMenu(
                    text: userNotes['type'] == "guest" ? "Guest" : userNotes['type'] as String,
                    icon: Icons.person,
                    press: () => {},
                  ),
                  ...
                  ProfileMenu(
                    text: (userNotes['userDetails'] as Map)['email'] as String,
                  ...
                  ProfileMenu(
                    ...
                    press: () => Navigator.of(context).pushNamed(SignInScreen.routeName),
                  ),
                  ProfileMenu(
                    text: "Sign Up",
                    icon: Icons.person_add_rounded,
                    press: () => Navigator.of(context).pushNamed(SignUpScreen.routeName),
                  ),
